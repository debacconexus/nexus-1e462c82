...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Oil & Gas Operations Management";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Operation Record";
process.env.TABLE_NAME = process.env.TABLE_NAME || "operation_record_records";
'use strict';
